...
const server = new Server(
  { name: "myindai-screenshot-mcp", version: "1.0.0-rc.5" },
  {
    capabilities: {
      tools: {},
      resources: {},
...
async function doctor() {
  ...
  process.stdout.write(`myindai-screenshot-mcp version : 1.0.0-rc.5\n`);
  ...
  process.stdout.write(`\n`);
  process.stdout.write(`v1.0.0-rc.5 status:\n`);
  process.stdout.write(`  - LLM not required for any working tool. Vision tools land in v1.0.0-rc.5 via MCP sampling.\n`);
...
async function main() {
  ...
  if (args.includes("--version") || args.includes("-v")) {
    process.stdout.write(`myindai-screenshot-mcp 1.0.0-rc.5\n`);
    return;
  }
  if (args.includes("--help") || args.includes("-h")) {
    process.stdout.write(
      [
        `myindai-screenshot-mcp 1.0.0-rc.5 — App Store / Play Store screenshot + video MCP`,
        ``,
        `Usage:`,
